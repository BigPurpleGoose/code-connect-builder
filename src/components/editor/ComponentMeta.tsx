  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-slate-50/60 p-5 space-y-4">
      ...
      <div>
        ...
        />
        {defErrors.figmaUrl && (
          <p className="mt-1 text-[11px] text-red-500">{defErrors.figmaUrl}</p>
        )}
      </div>
            ...
            {variantScope.map((v) => (
              ...
              >
                <input
                  ...
                  placeholder="State"
                  className="h-8 rounded-md border border-slate-300 bg-white px-2.5 font-mono text-xs focus:outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400"
                />
                <input
                  type="text"
                  value={v.value}
            ...
            {links.map((link) => (
              ...
              >
                <input
                  ...
                  className="h-8 rounded-md border border-slate-300 bg-white px-2.5 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500"
                />
                <div className="relative">
                  <Link2 className="absolute left-2 top-1/2 -translate-y-1/2 h-3 w-3 text-slate-400 pointer-events-none" />
                  <input
                    type="url"
                    value={link.url}
                    onChange={(e) =>
                    ...
                    placeholder="https://..."
                    className={cn(
                      "h-8 w-full rounded-md border border-slate-300 bg-white pl-6 pr-2.5 font-mono text-xs",
